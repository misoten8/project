...
namespace WiimoteApi
{
    ...
    public class WiimoteManager
    {
        ...
        //	戻り値: bool down : していしたボタンが押されていたらtrueを返す(プッシュ判定)
        //	説明  : Wiiリモコンボタンプッシュ情報取得処理関数
        //=============================================================================
        public static bool GetButton(int wmNum, int buttonNum)
        {
            ...
            switch (buttonNum)
            {
                case ButtonData.WMBUTTON_A:
                    down = Wiimotes[wmNum].Button.wmButton.a ? true : false;
                    break;
                case ButtonData.WMBUTTON_B:
                    down = Wiimotes[wmNum].Button.wmButton.b ? true : false;
                    break;

                case ButtonData.WMBUTTON_DOWN:
                    down = Wiimotes[wmNum].Button.wmButton.down ? true : false;
                    break;

                case ButtonData.WMBUTTON_HOME:
                    down = Wiimotes[wmNum].Button.wmButton.home ? true : false;
                    break;

                case ButtonData.WMBUTTON_LEFT:
                    down = Wiimotes[wmNum].Button.wmButton.left ? true : false;
                    break;

                case ButtonData.WMBUTTON_MINUS:
                    down = Wiimotes[wmNum].Button.wmButton.minus ? true : false;
                    break;

                case ButtonData.WMBUTTON_ONE:
                    down = Wiimotes[wmNum].Button.wmButton.one ? true : false;
                    break;

                case ButtonData.WMBUTTON_PLUS:
                    down = Wiimotes[wmNum].Button.wmButton.plus ? true : false;
                    break;

                case ButtonData.WMBUTTON_RIGHT:
                    down = Wiimotes[wmNum].Button.wmButton.right ? true : false;
                    break;

                case ButtonData.WMBUTTON_TWO:
                    down = Wiimotes[wmNum].Button.wmButton.two ? true : false;
                    break;

                case ButtonData.WMBUTTON_UP:
                    down = Wiimotes[wmNum].Button.wmButton.up ? true : false;
                    break;
            }
            return down;
        }
        ...
        //=============================================================================
        //	関数名: bool GetButtonTrigger(int wmNum, int buttonNum)
        //	引数  : int wmNum : Wiiリモコン番号, int buttonNum : 取得するボタンの種類(ButtonDataに定義あり)
        //	戻り値: bool down : していしたボタンが押されていたらtrueを返す(トリガー判定)
        //	説明  : Wiiリモコンボタントリガー情報取得処理関数
        //=============================================================================
        public static bool GetButtonTrigger(int wmNum, int buttonNum)
        {
            if (!HasWiimote(wmNum)) return false;
            ...
            {
                case ButtonData.WMBUTTON_A:
                    down = Wiimotes[wmNum].Button.wmButtonOld.a ? false : true;
                    down = Wiimotes[wmNum].Button.wmButton.a & down;
                    break;
                case ButtonData.WMBUTTON_B:
                    down = Wiimotes[wmNum].Button.wmButtonOld.b ? false : true;
                    down = Wiimotes[wmNum].Button.wmButton.b & down;
                    break;

                case ButtonData.WMBUTTON_DOWN:
                    down = Wiimotes[wmNum].Button.wmButtonOld.down ? false : true;
                    down = Wiimotes[wmNum].Button.wmButton.down & down;
                    break;

                case ButtonData.WMBUTTON_HOME:
                    down = Wiimotes[wmNum].Button.wmButtonOld.home ? false : true;
                    down = Wiimotes[wmNum].Button.wmButton.home & down;
                    break;

                case ButtonData.WMBUTTON_LEFT:
                    down = Wiimotes[wmNum].Button.wmButtonOld.left ? false : true;
                    down = Wiimotes[wmNum].Button.wmButton.left & down;
                    break;

                case ButtonData.WMBUTTON_MINUS:
                    down = Wiimotes[wmNum].Button.wmButtonOld.minus ? false : true;
                    down = Wiimotes[wmNum].Button.wmButton.minus & down;
                    break;

                case ButtonData.WMBUTTON_ONE:
                    down = Wiimotes[wmNum].Button.wmButtonOld.one ? false : true;
                    down = Wiimotes[wmNum].Button.wmButton.one & down;
                    break;

                case ButtonData.WMBUTTON_PLUS:
                    down = Wiimotes[wmNum].Button.wmButtonOld.plus ? false : true;
                    down = Wiimotes[wmNum].Button.wmButton.plus & down;
                    break;

                case ButtonData.WMBUTTON_RIGHT:
                    down = Wiimotes[wmNum].Button.wmButtonOld.right ? false : true;
                    down = Wiimotes[wmNum].Button.wmButton.right & down;
                    break;

                case ButtonData.WMBUTTON_TWO:
                    down = Wiimotes[wmNum].Button.wmButtonOld.two ? false : true;
                    down = Wiimotes[wmNum].Button.wmButton.two & down;
                    break;

                case ButtonData.WMBUTTON_UP:
                    down = Wiimotes[wmNum].Button.wmButtonOld.up ? false : true;
                    down = Wiimotes[wmNum].Button.wmButton.up & down;
                    break;
            }
            if (down == true)
            {
